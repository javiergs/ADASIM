package libraryHeadSimulatorOne;
 ...
 * It has implementaions for connecting, confirming connection, disconnecting, and publishing data to a subscriber all using an MQTT Client
 *
 * @author annonymous
 * @version 2025
 *
